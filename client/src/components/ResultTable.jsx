  ...
  return (
    <div className="font-poppins place-content-center">
      <div className="carousel-container">
        <Carousel showStatus={false} showIndicators={true} showThumbs={false} autoPlay interval={4000} infiniteLoop>
          {threeBiases.map((biasType, index) => (
            <div key={index} className="carousel-slide bg-white rounded mx-20 mb-8 py-18">
